    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Bakery", "Party Snacks" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "categoryId", "Name", "description" },
                values: new object[] { 2, "Lunch", "Wedding" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "categoryId", "Name", "description" },
                values: new object[] { 3, "Dinner", "Birthday" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "Name", "Price", "Quantity" },
                values: new object[] { 1, 1, "Ice Tea", 30.0, 10 });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "Name", "Price", "Quantity" },
                values: new object[] { 2, 1, "Canada Tea", 90.0, 30 });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "Name", "Price", "Quantity" },
                values: new object[] { 3, 2, "Burger", 20.0, 20 });
